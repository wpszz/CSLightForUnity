...
namespace ProtoBuf
{
        ...
        class Serializer
    {
        ...
        public static string GetProto(Type protoType)
        {
            return RuntimeTypeModel.Default.GetSchema(RuntimeTypeModel.Default.MapType(protoType));
        }
        /// <summary>
        ...
        {
            return instance == null ? instance : RuntimeTypeModel.Default.DeepClone(instance);
        }
        /// <summary>
        ...
        public static object Merge(Stream source, object instance, Type objType)
        {
            return RuntimeTypeModel.Default.Deserialize(source, instance, objType);
        }
        /// <summary>
        ...
        public static object Deserialize(Stream source, Type objType)
        {
            return RuntimeTypeModel.Default.Deserialize(source, null, objType);
        }
        ...
        public static object ChangeType(object instance, Type targetType)
        {
